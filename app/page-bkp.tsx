...
const Home = (props: Props) => {
    ...
    const [faceShape, setFaceShape] = useState<string | null | undefined>(undefined);
        ...
        if (
            ...
            if (
                ...
                if (faceLandmarkPrediction) {
                    ...
                    if (faceLandmarkPrediction.faceLandmarks && faceLandmarkPrediction.faceLandmarks.length > 0) {
                        try {
                            const faceShape = FaceLandmarkDetection.classifyFaceShape(
                                faceLandmarkPrediction.faceLandmarks[0]
                            );
                ...
                >
                    ...
                    <div className="flex flex-row gap-2">
                        ...
                        <Volume
                            ...
                            beep={beep}
                        /> */}
                        <div className="flex items-center border-primary/5 border-2 rounded-md p-2">Shape: {faceShape}</div>
                    </div>
                </div>
            </div>
            {loading && (
